...
(function() {
  ...
  $(document).ready(function() {
    var board, offset;
    board = (function() {
      var addTopic, bindEvents, bindSpaceTimeClick, destroyModal, dispatcher, lockCell, modal, modalContent, newTopicFailure, newTopicSuccess, unlockCell, updateModal, validSpaceTimes;
      ...
      */
      ...
      bindEvents = function() {
        dispatcher.bind('new_topic', function(topic) {
          addTopic(topic);
          return true;
        });
        dispatcher.bind('lock_spacetime', function(topic) {
          lockCell(topic);
          return true;
        });
        dispatcher.bind('unlock_spacetime', function(topic) {
          unlockCell(topic);
          return true;
        });
        return true;
      ...
      */
      ...
      addTopic = function(topic) {
        ...
        topicCell.off('click');
        topicCell.html('<div class="topic">\
            <b>' + topic.title + '</b><br/>' + topic.desc + '<br/>\
      ...
      */
      ...
      bindSpaceTimeClick = function(e) {
        var $this, room, spaceTimeId, time;
        $this = $(this);
      ...
      */
      ...
      updateModal = function(spaceTimeId, room, time) {
        dispatcher.trigger('lock_spacetime', {
      ...
      */
      ...
      destroyModal = function(spaceTimeId, $this) {
        dispatcher.trigger('unlock_spacetime', {
          space_time_id: spaceTimeId
        });
        $('.topic-errors').hide();
        $('.topic-room').html('');
      ...
      */
      ...
      newTopicSuccess = function(e, data, status, xhr, spaceTimeId) {
        modal.modal('hide');
        dispatcher.trigger('unlock_spacetime', {
          space_time_id: spaceTimeId
        });
        dispatcher.trigger('new_topic', {
          space_time_id: spaceTimeId
        });
        return true;
      };
      ...
      */
      ...
      newTopicFailure = function(e, xhr, status, error) {
        var errorText, errors, key, value;
